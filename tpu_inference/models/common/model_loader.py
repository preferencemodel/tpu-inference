...
def _get_model_architecture(config: PretrainedConfig) -> nnx.Module:
    ...
    from tpu_inference.models.jax.gemma3_mm import Gemma3ForConditionalGeneration
    ...
    _MODEL_REGISTRY["Gemma3ForConditionalGeneration"] = Gemma3ForConditionalGeneration
